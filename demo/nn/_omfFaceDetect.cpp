...
static OmfHelper::Item _options0[]{
	{"omfFaceDetect(...): \n"
	 "this demo is to start the FaceDetect service to detect faces"
	 ", and post the result message when it detect over. eg..\n"
	 "> omfFaceDetect -w 640 -h 360 -f 1 -d 3600\n"
	},
...
static bool Process(bool _dbg){
		...
		"type=ShmService,index=1,partner={"
			"type=Application,name=app-facesdetect,layout={"
				"type=Pipeline,name==pl-faces-detect,layout={"
					"pv-yuv-src:w="+_width+",h="+_height+
					"+FrameRateCtrl:fr="+_fr+  
					"+FaceDetect:name=facesdetection,dur=500"  
					"+FakeSink:live=false"
				"}"
			"}"
		"}"
