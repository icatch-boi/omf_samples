...
static int _comp=1;
static int _framesize = 20;
static int _vbr=1;
static int _bitrate=30000;
static const char* _application = "voip";
static int _frameDur_ms = 100;
////////////////////////////////////////////
...
static OmfHelper::Item _options0[]{
	{"omfOggMuxer(...): \n"
	 ...
	 "> omfOggMuxer -n test.opus -d 10 -r 16000 -c 1 -p 1 -v 1 -b 30000 -f 20\n"
     "> https://www.yuque.com/tinycloud/linux/oi570z\n"
	},
	{"fname"	,'n', _fname 		,"set the file name."},
	{"filedur"	,'d', _seconds 		,"set the file name."},
	{"app",'a', _application		,"set the record duration(*s)."},
	{"rate",'r', _rate				,"set the sample rate of audio."},
	{"ch",'c', _channels			,"set the channels of audio."},
	{"complexity",'p', _comp			,"set the comp of audio."},
	{"framesize",'f', _framesize			,"set the opus encode frame duration"},
	...
	auto layout = (std::string)
		"type=Application,layout={"
			"type=Pipeline,layout={"
				...
				"+OpusplusAudEncoder:name=opusEnc,a="+_application+",complexity="+_comp+",frame_duration="+_frameDur_ms+"ms"+",framesize="+_framesize+",vbr="+_vbr+",bitrate="+_bitrate+
