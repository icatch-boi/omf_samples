...
static int _rate=8000; //G711 only support 8000 samplerate
...
static OmfHelper::Item _options0[]{
	{"omfG711Recorder(...): \n"
	 ...
	 "> omfG711Recorder -n test.wav -d 10 -c 1 -m alaw\n"
	 "> omfG711Recorder -n test.wav -d 10 -c 1 -m ulaw \n"
	},
	...
	auto layout = (std::string)
		"type=Application,layout={"
			"type=Pipeline,layout={"
				...
				_encoder+
				"+G711Encoder:name=g711en,codec=" +_codec+
