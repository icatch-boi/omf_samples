...
typedef void (*pushMsgResultCb)(int msgType, remotePushErrno_e retVal);
...
typedef struct _remotePushMsgBody_t {
	...
	pushMsgResultCb resultCb;
}remotePushMsgBody_t;

typedef void (*pushFileResultCb)(remotePushErrno_e retVal);
